...
class Countdown(commands.Cog):
    def __init__(self, bot):
        ...
        self.bot.loop.create_task(self.setup_countdown())

    async def setup_countdown(self):
        countdown = await self.db.find().to_list(None)
        for i in countdown:
            if i['_id'] != 'config':
    ...
    async def create(self, ctx, *, time: UserFriendlyTime):
        ...
        try:
            ...
            await ctx.send('I have insufficient permissions to manage voice channels. Allow me to "Manage Channels"')
            return
        ...
        await ctx.send('Countdown created! You can view the new voice channel in the "Countdowns" category.')
    ...
    async def trigger_countdown(self, data):
        ...
        while True:
            try:
                ...
                logger.error('I have insufficient permissions to manage voice channels. Allow me to "Manage Channels"')
                return
