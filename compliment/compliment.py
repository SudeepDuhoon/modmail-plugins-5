...
class Compliment(Cog):
    """
    Recieve a compliment from your bot!
    """
    ...
    async def _compliment(self, ctx):
        """
        Get complimented.
        """
        embed = discord.Embed(color=15383739, description='choice(self.compliment)')
